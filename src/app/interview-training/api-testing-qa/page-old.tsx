export default function Page() {
  const qaList = [
    ...
    { q: "What is API analytics?", a: "API analytics provides insights into API usage patterns." },
    { q: "What is API throttling?", a: "API throttling limits request rates to prevent abuse." },
    { q: "What is API quota?", a: "API quota sets usage limits per user or application." },
    { q: "What is API billing?", a: "API billing charges based on usage metrics." },
    { q: "What is API marketplace?", a: "API marketplace allows discovery and consumption of APIs." },
    { q: "What is API management?", a: "API management includes design, deployment, security, and monitoring." },
    { q: "What is API governance?", a: "API governance ensures APIs follow standards and best practices." },
    ...
    { q: "What is API mocking?", a: "API mocking creates simulated API responses for development and testing." },
    ...
    { q: "What is API compliance testing?", a: "API compliance testing ensures adherence to standards." },
    { q: "What is API interoperability testing?", a: "API interoperability testing ensures compatibility between systems." },
    { q: "What is API certification testing?", a: "API certification testing verifies compliance with certification requirements." },
    { q: "What is API accreditation testing?", a: "API accreditation testing verifies compliance with organizational standards." },
    { q: "What is API audit testing?", a: "API audit testing reviews API usage and compliance." },
    ...
    { q: "What is API security testing?", a: "API security testing identifies and validates security controls." },
    ...
    { q: "What is API reliability testing?", a: "API reliability testing measures consistent performance." },
    ...
    { q: "What is API gateway?", a: "API gateway manages and secures API traffic." },
    ...
    { q: "What is API management?", a: "API management includes lifecycle management and operations." },
